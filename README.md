...
## Bot Information
Engine:
- [Stockfish Dev lastest SSE4.1 + POPCNT](http://abrok.eu/stockfish/latest/linux/stockfish_x64_modern.zip) with the default NNUE.
...
- You can reset link in [16th line in Dockerfile](/Dockerfile#L16) to the Stockfish dev binary link from [Stockfish Dev web](https://abrok.eu/stockfish/)
